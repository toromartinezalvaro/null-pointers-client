            ...
            <div className="flex flex-col md:flex-row items-center justify-center gap-16 lg:gap-32 w-full max-w-5xl">
              <div className="flex flex-col items-start max-w-md">
                ...
                <div className="flex gap-3">
                  <button 
                    className="inline-flex items-center gap-2 px-5 py-2.5 bg-white text-[#0033A0] hover:bg-white/90 text-sm font-medium rounded-lg transition-colors shadow-lg"
                  ...
                  <button 
                    className="inline-flex items-center gap-2 px-5 py-2.5 border border-white/30 text-white hover:bg-white/10 text-sm font-medium rounded-lg transition-colors"
